...
# ✅ Convertir CSV a Parquet con Spark
convert_csv_to_parquet = SparkSubmitOperator(
    task_id="convert_csv_to_parquet",
    application="/opt/airflow/scripts/convert_csv_to_parquet.py",
...
convert_csv_to_parquet >> load_parquet_to_hudi
